...
##
## Debug
ProjectName            :=ascii_display
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/Maria/Documents/IT/MOP/MOP
ProjectPath            :=C:/Users/Maria/Documents/IT/MOP/MOP/ascii_display
...
ObjectsFileList        :="ascii_display.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/ascii_display.elf ./Debug/ascii_display.s19
	arm-none-eabi-objdump -D -S ./Debug/ascii_display.elf > ./Debug/ascii_display.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Maria/Documents/IT/MOP/MOP/ascii_display/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
