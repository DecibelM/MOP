...
ProjectPath            :=C:/Users/Maria/Documents/IT/MOP/MOP/unaligned
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/unaligned.elf ./Debug/unaligned.s19
	arm-none-eabi-objdump -D -S ./Debug/unaligned.elf > ./Debug/unaligned.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Maria/Documents/IT/MOP/MOP/unaligned/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
